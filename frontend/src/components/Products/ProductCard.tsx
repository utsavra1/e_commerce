    ...
    return(
      ...
      <div className="px-2">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="bg-gray-900 text-white p-3 rounded-xl hover:bg-indigo-600 hover:-translate-y-1 transition-all duration-300 shadow-lg shadow-gray-200 hover:shadow-indigo-200">
